...
public class DuelService {
    ...
    public ResponseEntity<Object> getOrCreateDuel() {
        ...
        System.out.println("Response:" +
                response.getId() +
                response.getCategory() + response.getCard1Id() + response.getCard1Category() + response.getCard1Username() +
                response.getCard2Id() + response.getCard2Category() + response.getCard2Username()
        );
